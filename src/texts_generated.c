...
const DialogItem act1_dialog1[] = {
    ...
    [A1D1_TERM_2] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    ...
    [A1D1_TERM_3] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
...
const DialogItem act1_dialog2[] = {
    ...
    [A1D2_TERM_1] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    ...
    [A1D2_TERM_2] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    ...
    [A1D2_TERM_3] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    ...
    [A1D2_TERM_4] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    ...
    [A1D2_LINUS_MOTHER] = { FACE_linus, SIDE_RIGHT, 100,
        {"Madre...",
         "Mother..."} },
    [A1D2_TERM_5] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
...
const DialogItem act1_dialog3[] = {
    ...
    [A1D3_TERM_1] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    [A1D3_3BUTTONS] = { FACE_none, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Vaya, parece que estás usando|@[un mando de tres botones@]",
         "Oops, it seems you are using|@[a three-button controller@]"} },
    [A1D3_BUTTONS_HINT] = { FACE_none, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D3_TERM_2] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    ...
    [A1D3_REVERSE_HINT] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D3_GOOD_IDEA_HIDE] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
...
const DialogItem act1_dialog4[] = {
    ...
    [A1D4_TERM_1] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    ...
    [A1D4_TERM_2] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
    ...
    [A1D4_TERM_3] = { 0, false, DEFAULT_TALK_TIME, { NULL, NULL } },
