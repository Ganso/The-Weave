...
const DialogItem act1_dialog2[] = {
    ...
    [A1D2_MONDAY_MORNING] = { FACE_none, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D2_CLIO_TELL_LATER] = { FACE_clio, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D2_XANDER_ABILITY] = { FACE_xander, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Según la leyenda|Fueron un gremio|capaz de tejer hechizos",
         "According to the legend|They were a guild|able to weave spells"} },
    [A1D2_XANDER_NOT_LEGEND] = { FACE_xander, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D2_XANDER_FATHERS_AGE] = { FACE_xander, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Y la edad de su padre cuando|llegó aquí",
         "And his father's age when|he came to us"} },
    [A1D2_XANDER_BEFORE_JOINED] = { FACE_xander, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D2_CLIO_I_WONT_LET_YOU] = { FACE_clio, SIDE_LEFT, DEFAULT_TALK_TIME,
...
const DialogItem act1_dialog3[] = {
    [A1D3_SOME_TIME_LATER] = { FACE_none, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Algún tiempo después",
         "Some time later"} },
    [A1D3_ENEMIES_APPROACHING] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D3_TRY_HIDE_OR_THUNDER] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Puedo probar a esconderme|o tratar de invocar|al trueno",
         "I could try to hide|or attempt to summon|the thunder"} },
    [A1D3_REVERSE_NOTES_COUNTER] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D3_CANT_CAST_WHILE_HIDDEN] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
...
const DialogItem act1_dialog4[] = {
    ...
    [A1D4_NEXT_MORNING] = { FACE_none, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"A la mañana siguiente...",
         "The next morning..."} },
    [A1D4_SLEPT_BAD] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
    ...
    [A1D4_NO_TIME_TO_SIT] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"No tengo tiempo de sentarme|Madre me espera",
         "I don't have time to sit down|Mother waiting for me"} },
    ...
    [A1D4_ENTER_PAUSE_MENU] = { FACE_none, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Entra en el menú de|pausa para verlo",
         "Enter the pause menu|to check it out"} },
    [A1D4_MOTHER_CALLS] = { FACE_clio, SIDE_RIGHT, DEFAULT_TALK_TIME,
        {"Linus, ¿dónde estás?",
         "Linus, where are you?"} },
