...
void handle_character_movement(s16 dx, s16 dy); // Move the character if there's no collision and it's within the screen limits
void update_character_animation(bool moved); // Update the character's animation based on whether it moved or not
