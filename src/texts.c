...
const char **dialog[] =
{
    ...
    (const char *[])
    {
        "Es tarde, Linus|Y uno no debe llegar tarde|a su cumplea^os", "It's late, Linus|And you shouldn' be late|at your birthday", // 0 - First dialog, start
        "He tenido el sue^o|mas exta^o, madre", "I have had the strangest|dream, mother",
        ...
        "Linus tiene diecisiete a^os|Esa era mi edad cuando|viaje por el mundo", "Linus is seventeen|That was my age when|I traveled the world",
    ...
    // Act 1, dialog 2 (intro)
    (const char *[])
    {
        "Gremio de los historiadores|A^o 8121", "Historians guild|Year 8121", // 0 - Intro, start
        "Lunes|Primera hora de la ma^ana", "Monday|Early morning",
        NULL
    },
    // Act 1, dialog 3 ()
    (const char *[])
    {
        ...
        "Bueno, pues ya aprendi|algunos patrones", "Well, so I learned|some patterns",
        NULL
    }
};
