...
const DialogItem act1_test[] = {
    ...
    [A1_TEST_INTRO_2] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Verás diálogos encadenados,|movimientos y un cast|automático de @[sleep@]",
         "You will see chained dialogs,|movements and a scripted|@[sleep@] cast"} },
    [A1_TEST_INTRO_3] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Después, un @[choice@]:|probar el puzzle o|saltar directo al combate",
         "Then a @[choice@]:|try the puzzle or|skip straight to combat"} },
    [A1_TEST_INTRO_4] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"El @[puzzle@] pide lanzar|@[trueno@], @[fuego@] y @[esconderse@]|en ese orden",
         "The @[puzzle@] asks you to cast|@[thunder@], @[fire@] and @[hide@]|in that order"} },
    [A1_TEST_INTRO_5] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Fallar un hechizo|reinicia la secuencia|desde el principio",
         "Casting the wrong spell|restarts the sequence|from the beginning"} },
    [A1_TEST_INTRO_6] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Al final: camina a la|derecha y vence al fantasma|con el @[counter@]",
         "At the end: walk right|and defeat the ghost|with the @[counter@]"} },
    ...
    [A1_TEST_PUZZLE_INTRO] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"TEST: La puerta pide una|secuencia de tres hechizos:|@[trueno@], @[fuego@], @[esconderse@]",
         "TEST: The door demands a|three-spell sequence:|@[thunder@], @[fire@], @[hide@]"} },
    [A1_TEST_PUZZLE_INTRO_2] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"Consulta las notas de cada|hechizo en el menú de pausa|(botón @[START@])",
         "Check each spell's notes|in the pause menu|(@[START@] button)"} },
    ...
    [A1_TEST_COMBAT] = { FACE_linus, SIDE_LEFT, DEFAULT_TALK_TIME,
        {"TEST: ¡Un fantasma!|Contrarresta su trueno|con las notas invertidas",
         "TEST: A ghost!|Counter its thunder|with the reversed notes"} },
