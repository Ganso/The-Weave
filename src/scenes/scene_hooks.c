...
const SceneHook scene_hook_table[HOOK_COUNT] = {
    ...
    [HOOK_ACT1_RETURN_TORCH_OUT] = act1_return_torch_out,
    [HOOK_ACT1_RETURN_WAIT_LIGHT] = act1_return_wait_light,
    [HOOK_ACT1_RETURN_TORCH_RELIGHT] = act1_return_torch_relight,
