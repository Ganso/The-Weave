...
| # | Decisión | Valor |
|---|---|---|
| D1 | Dependencias entre módulos | **Includes explícitos por archivo**. El Makefile añade `-Isrc -Ires`; los includes se escriben relativos a esas raíces: `#include "spells/spell.h"`, `#include "res_sound.h"`. Sin rutas `../`. `globals.h` desaparece **al final de la Fase 5** (no en la 3; ver §5.4). |
